...
<figure class="highcharts-figure">
    ...
    <p class="highcharts-description">
        Berikut adalah vendor yang paling banyak memberikan stocked quantity
    </p>
</figure>
    ...
    title: {
        text: 'Graphic Vendor yang memberikan stocked quantity dengan jumlah terbanyak',
        align: 'center'
    },
    tooltip: {
    ...
    series: [{
		...
		{
			$nama = $temp['nama'];
			$stok_barang = $temp['stok_barang'];
			echo "['".$nama."',".$stok_barang."],";
		}
		?>
		]
    }]
